...
namespace QueryBuilder
{
    public class Join
    {
        ...
        /// <summary>
        /// Tables to join ,please make sure that these tables has IdColumns Property is not null
        /// </summary>
        /// <param name="leftTable"></param>
        /// <param name="joinType"></param>
        /// <param name="rightTable"></param>
        //public Join(Table leftTable, JoinTypes joinType, Table rightTable)
        //    : this(leftTable.IdColumn, joinType, rightTable.IdColumn)
        //{
        //}
